...
def load_vgg(sess, vgg_path):
    ...
    tensor_names = [vgg_input_tensor_name, vgg_keep_prob_tensor_name, vgg_layer3_out_tensor_name,
    ...
    # Restore variables and return them
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    output = tf.layers.conv2d_transpose(one_by_one_convolution_vgg_layer_out7,
                                        num_classes,
                                        4,
                                        2,
                                        padding="same",
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    for epoch in range(epochs):
        for batch_number, (image, label) in enumerate(get_batches_fn(batch_size)):
...
def run():
    ...
    with tf.Session() as sess:
        ...
        logits, optimizer, loss = optimize(output_layer, correct_label_placeholder, learning_rate, num_classes)

        # Train NN using the train_nn function
        sess.run(tf.global_variables_initializer())
        train_nn(sess, epochs, batch_size, get_batches_fn, optimizer, loss, image_input,
                 correct_label_placeholder, keep_prob, learning_rate)
